...
function Sessions() {
  ...
  const playersList = ["Anil", "Viswa", "Venkat", "Ravi", "Yaswanth", "Satya Vinay", "Suresh", "Sailesh", "Chandra", "Abhishek", "Naveen", "Akshay","Satya", "Puneeth","Uchit","Mazar","Rajesh","Satish", "Praveen"];
